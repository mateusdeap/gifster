...
RSpec.describe Gif, type: :model do
  ...
  it "requires the image to be a gif" do
    gif = Gif.new
    gif.image.attach(io: File.open("./spec/models/test.jpeg"), filename: "test.jpeg", content_type: "image/jpeg")
  ...
  it "succeeds validations if it is a gif" do
    gif = Gif.new
    gif.image.attach(io: File.open("./spec/models/gif_2.gif"), filename: "gif_2.gif", content_type: "image/gif")
